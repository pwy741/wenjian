...
var rescod= fetch(arrr+"?ac=list",{headers:{"Cookie":"vdata=d5151d3199cc4cdaa6520265f697d248"}});
...
html=fetch(MY_URL+html.split('\"')[1], {headers:{"Cookie":"vdata=d5151d3199cc4cdaa6520265f697d248"}});
}
...
var items = [];
var html = getResCode();
if(html.indexOf("xmcloud") != -1){html=fetch(MY_URL, {headers:{"Cookie":"vdata=d5151d3199cc4cdaa6520265f697d248"}});}
try{
