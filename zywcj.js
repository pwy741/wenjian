...
if(MY_URL.indexOf("pangniaozyw")!=-1||MY_URL.indexOf("leshizyw")!=-1){pic="https://tu.tianzuida.com/pic/"+pic;}else if(MY_URL.indexOf("lby")!=-1){pic.indexOf("http")!=-1?pic=pic:pic="http://cj.lby.pet/"+pic};
/((http|https):\/\/.*?)\/.*?/.test(pic);
...
if(MY_URL.indexOf("pangniaozyw")!=-1||MY_URL.indexOf("leshizyw")!=-1){
