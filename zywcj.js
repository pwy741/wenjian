...
}else if(MY_URL.indexOf("xjiys")!=-1){thumb=thumb.replace("img.maccms.com","xjiys.com");}else if(MY_URL.indexOf("17kanju")!=-1){thumb=thumb.replace("img.maccms.com","3.17kanju.com");}
